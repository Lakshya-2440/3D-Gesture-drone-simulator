"""
3D Gesture-Driven Drone Simulator
Pure Python/OpenCV launcher - runs directly without a web server
"""
...
def main():
    ...
    print("\n" + "="*60)
    print("  J.A.R.V.I.S. GESTURE DRONE SIMULATOR")
    print("="*60)
    print("\n  Controls:")
    print("  • Rock (fist) = LAND")
    print("  • Palm (all fingers + thumb) = HOVER")
    print("  • 1 finger (index) = FORWARD")
    print("  • 2 fingers (index + middle) = BACKWARD")
    print("  • 3 fingers (index + middle + ring) = RIGHT")
    print("  • 4 fingers (all except thumb) = LEFT")
